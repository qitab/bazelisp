...
\renewcommand{\titleAndVersionAndAuthors}[3]{\title{#1}\author{#3}\maketitle}
...
\renewcommand{\SAuthorinfo}[3]{\alignauthor #1 \\ \affaddr{#2} \\ \email{#3}}
\renewcommand{\SAuthorSep}[1]{}

\renewcommand{\SNumberOfAuthors}[1]{\numberofauthors{#1}}

\renewcommand{\SConferenceInfo}[2]{\conferenceinfo{#1}{#2}}
\renewcommand{\SCopyrightYear}[1]{\CopyrightYear{#1}}
\renewcommand{\SCopyrightData}[1]{\crdata{#1}}
